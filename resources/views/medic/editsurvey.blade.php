...
@section('content')
    ...
    <div class="main_container">
        ...
        <fieldset>
            <div class="inputs">
                ...
                <div class="form-group">
                    <label for="start_date"
                           class="col-lg-2 col-xs-offset-1 col-md-offset-1 col-lg-offset-0 control-label">Dată
                        de început</label>
                ...
                <div class="form-group">
                    <label for="title" class="col-lg-2 col-xs-offset-1 col-md-offset-1 col-lg-offset-0 control-label">Titlu</label>
            ...
            <div class="form-group">
                <div class="col-xs-8 col-lg-5 col-xs-offset-1 col-lg-offset-2">
                    <button type="submit" class="btn btn-warning">Editare</button>
                    <a href="#" class="btn btn-success col-xs-offset-3" title="Adăugare întrebare" id="btn-plus"><span
