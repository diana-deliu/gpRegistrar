    ...
    <div class="main_container">
        ...
        <table class="table table-striped table-hover patients">
            ...
            <tr>
                ...
                <th>
                    <input type="text" class="form-control input-sm" placeholder="Nume">
                </th>
                <th>
                    <input type="text" class="form-control input-sm" placeholder="Prenume">
                </th>
            </tr>
            </thead>
            <tbody>
            @foreach($consults as $consult)
                <tr>
                    <td><a href="{{url('patient/consult_details').'/'.$consult['id']}}">{{ $consult['id'] }}</a></td>
                    <td>{{ $consult['date'] }}</td>
